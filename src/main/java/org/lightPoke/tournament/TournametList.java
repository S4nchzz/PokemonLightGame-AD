...
public class TournametList {
    private static TournametList instance;
    private List<Tournament> tournamentList;
    private final LogManagement log;

    private TournametList() {
    ...
    public static TournametList getInstance() {
        return instance == null ? instance = new TournametList(): instance;
    }
